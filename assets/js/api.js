...
import { SUPABASE_URL, SUPABASE_ANON_KEY, REGISTRATION_TIME } from "./config.js?v=20260727c";
import {
  mockGetSeats,
  mockGetAllMembers,
...
async function getAllMembers() {
  try {
    const data = await fetchAllRows("Member", "ID,Name,Division,Phone", null, ["Division", "Name"]);
